...
import com.dkd.framework.web.enumerate.IntegrityViolationType;
...
//        }
        ...
        for (IntegrityViolationType type : IntegrityViolationType.values()) {
            if (message != null && message.contains(type.getKeyword())) {
                return AjaxResult.error(type.getMessage());
            }
        }
