...
public class EmpController extends BaseController
{
    ...
    public AjaxResult businessList(@PathVariable("innerCode") String innerCode) {
        return getAjaxResult(innerCode, DkdContants.ROLE_CODE_BUSINESS);
    }
    ...
    public AjaxResult getOperationList(@PathVariable("innerCode") String innerCode) {
        // 1.查询售货机信息
        return getAjaxResult(innerCode, DkdContants.ROLE_CODE_OPERATOR);
    }

    private AjaxResult getAjaxResult (String innerCode, String roleCode) {
        ...
        empParam.setRoleCode(roleCode);// 角色编码：维修员
